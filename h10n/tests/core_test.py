...
def extension_test():
    ...
    result = server['en-US.helpers_test.extension'].format(a=3, b=3)
    tools.eq_(result, '12')

    # Using generic (built-in) helpers
    result = server['en-US.helpers_test.generic'].format()
    tools.eq_(result, '3')
